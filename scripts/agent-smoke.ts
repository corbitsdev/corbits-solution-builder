...
const { createProject, install } = await import("./host-install.js");
const { localActor } = await import("../apps/hub/src/hub-client.js");
const { connectProvider, selectModel } = await import("./lib/dev-provider.js");
const { projectDetail, writeArtifact } = await import("../apps/hub/src/projects.js");
