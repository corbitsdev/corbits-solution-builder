 ...
 */
import { describeProviderFailure, humanDuration } from "../src/orchestration/providers/failure.js";
import { aggregateRefusal } from "../src/orchestration/providers/inference.js";
...
// parameter without another wasted round trip.
{
  const { retriesWithoutTemperature } = await import(
    "../src/orchestration/providers/inference.js"
  );
  check(
