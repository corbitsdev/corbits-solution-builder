...
/**
 * Ported from origin/main `apps/hub/src/oauth-page.ts` (PR #142) — itself
 * ported from Corbits Code's `auth/callback-page.ts`.
 *
 ...
 * dithered draw/fill timeline, drawn in pixels the way the terminal draws it
 * in block characters.
 *
