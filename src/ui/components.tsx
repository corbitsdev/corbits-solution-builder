...
export function GuideDock({
  ...
  step: import("../contracts/next-step.js").NextStep;
  onGo: (where: import("../contracts/next-step.js").NextStep["where"]) => void;
  onExplain: () => void;
  guidance: import("./client.js").Guidance | null;
  explaining: boolean;
  at?: import("../contracts/next-step.js").NextStep["where"];
