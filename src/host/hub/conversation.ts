 ...
 * standing-brief table — see `orchestration/agents/conversation.ts`, which
...
import { getWorkflowDefinitionId } from "./workflows.js";
import { STAGE_WORKFLOW_ID } from "../../orchestration/workflows/stage-loop.js";
